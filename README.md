...
│   ├── assets/
│   ├── components/
│   │   ├── AQICard.jsx        # AQI summary + pollutant cards
│   │   ├── Chart.jsx          # Chart.js wrapper
│   │   ├── LocationSearch.jsx # Nominatim-based place search
│   │   ├── Navbar.jsx
│   │   └── Sidebar.jsx        # Left nav (Dashboard, Live Map, Stations, Analytics, Reports, Settings)
│   ├── contexts/
│   │   └── ThemeContext.jsx   # Dark/light theme provider
│   ├── hooks/
│   │   └── useAirQuality.js   # Fetches & computes AQI for all stations
│   ├── pages/
│   │   ├── Dashboard.jsx
│   │   ├── LiveMap.jsx
│   │   ├── Stations.jsx
